            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a href="{{ url('/horario') }}" class="nav-link"><i class="bi-house text-info"></i> Horario</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/seccion_polimorfa') }}" class="nav-link"><i class="bi-house text-info"></i> Seccion_polimorfa</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/secciones') }}" class="nav-link"><i class="bi-house text-info"></i> Secciones</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/users') }}" class="nav-link"><i class="bi-house text-info"></i> Users</a> 
                        </li>
						<li class="nav-item">
