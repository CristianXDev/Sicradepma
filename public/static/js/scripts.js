...
(function($) {
    ...
    $("#signUpForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            ...
            sformError();
            ssubmitMSG(false, "¡Por favor, rellene todos los campos!");
        } else {
    ...
    $("#logInForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            lformError();
            lsubmitMSG(false, "¡Por favor, rellene todos los campos!");
        } else {
            // everything looks good!
            event.preventDefault();
            lsubmitForm();
    ...
    $("#newsletterForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            nformError();
            nsubmitMSG(false, "¡Por favor, rellene todos los campos!");
        } else {
            // everything looks good!
            event.preventDefault();
            nsubmitForm();
    ...
    $("#privacyForm").validator().on("submit", function(event) {
    	if (event.isDefaultPrevented()) {
            // handle the invalid form...
            pformError();
            psubmitMSG(false, "¡Por favor, rellene todos los campos!");
        } else {
            // everything looks good!
            event.preventDefault();
            psubmitForm();
